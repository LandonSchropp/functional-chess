...
describe("removePiece", () => {
  describe("when the square contains a piece", () => {
    it("removes the piece", () => {
      expect(removePiece(STARTING_POSITION, "b2")).toEqual(
  ...
  describe("when the square is empty", () => {
    it("returns the same fen", () => {
      expect(removePiece(STARTING_POSITION, "b3")).toEqual(STARTING_POSITION);
    });
  });

  describe("when the FEN is a Fen0x88", () => {
    it("removes the piece", () => {
      expect(removePiece(parseFen(STARTING_POSITION), "b2")).toEqual(
