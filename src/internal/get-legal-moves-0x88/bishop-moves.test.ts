...
describe("getLegalMoves0x88 (bishop moves)", () => {
    ...
    describe("when the target squares are occupied by the player", () => {
      describe("when the player is white", () => {
        it("does not include the occupied target squares or the blocked squares", () => {
          ...
          expect(getLegalMoves0x88(fen, H1_0x88)).toMatchMoves([encodeMove0x88(H1_0x88, G2_0x88)]);
        });
      });
      ...
      describe("when the player is black", () => {
        it("does not include the occupied target squares or the blocked squares", () => {
          ...
          expect(getLegalMoves0x88(fen, H8_0x88)).toMatchMoves([encodeMove0x88(H8_0x88, G7_0x88)]);
        });
      });
    });
  });
