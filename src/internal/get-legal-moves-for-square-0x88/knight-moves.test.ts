...
describe("getLegalMovesForSquare0x88 (knight moves)", () => {
    ...
    describe("when the target squares are empty", () => {
      describe("when the player is white", () => {
        it("returns the knight moves", () => {
          ...
          expect(getLegalMovesForSquare0x88(fen, A1_0x88)).toMatchMoves([
      ...
      describe("when the player is black", () => {
        it("returns the knight moves", () => {
          ...
          expect(getLegalMovesForSquare0x88(fen, A8_0x88)).toMatchMoves([
