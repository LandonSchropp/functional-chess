...
describe("getLegalMovesForSquare0x88 (pawn moves)", () => {
  describe("when the pawn is on its starting square and is not blocked", () => {
    describe("when the player is white", () => {
      it("returns the single and double pawn moves", () => {
        ...
        expect(getLegalMovesForSquare0x88(fen, E2_0x88)).toMatchMoves([
    ...
    describe("when the player is black", () => {
      it("returns the single and double pawn moves", () => {
        ...
        expect(getLegalMovesForSquare0x88(fen, E7_0x88)).toMatchMoves([
  ...
  describe("when the pawn can legally capture to the left", () => {
    describe("when the pawn is not on the rank before it would promote", () => {
      describe("when the player is white", () => {
    ...
    describe("when the pawn is on the rank before it would promote", () => {
      describe("when the player is white", () => {
        it("returns the capture with the promotions", () => {
          const fen = parseFen("3rb3/k3P3/8/8/8/8/K7/8 w - - 0 1");

          expect(getLegalMovesForSquare0x88(fen, E7_0x88)).toMatchMoves([
            encodeMove0x88(E7_0x88, D8_0x88, WHITE_KNIGHT_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E7_0x88, D8_0x88, WHITE_BISHOP_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E7_0x88, D8_0x88, WHITE_ROOK_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E7_0x88, D8_0x88, WHITE_QUEEN_0x88, CAPTURE_FLAG_0x88),
          ]);
        });
      });

      describe("when the player is black", () => {
        it("returns the capture with the pormotions", () => {
          const fen = parseFen("8/k7/8/8/8/8/K3p3/3RB3 b - - 0 1");

          expect(getLegalMovesForSquare0x88(fen, E2_0x88)).toMatchMoves([
            encodeMove0x88(E2_0x88, D1_0x88, BLACK_KNIGHT_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E2_0x88, D1_0x88, BLACK_BISHOP_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E2_0x88, D1_0x88, BLACK_ROOK_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E2_0x88, D1_0x88, BLACK_QUEEN_0x88, CAPTURE_FLAG_0x88),
          ]);
        });
      });
    });
  ...
  describe("when the pawn can legally capture to the right", () => {
    ...
    describe("when the pawn is on the rank before it would promote", () => {
      describe("when the player is white", () => {
        it("returns the capture with the promotions", () => {
          const fen = parseFen("4br2/k3P3/8/8/8/8/K7/8 w - - 0 1");

          expect(getLegalMovesForSquare0x88(fen, E7_0x88)).toMatchMoves([
            encodeMove0x88(E7_0x88, F8_0x88, WHITE_KNIGHT_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E7_0x88, F8_0x88, WHITE_BISHOP_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E7_0x88, F8_0x88, WHITE_ROOK_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E7_0x88, F8_0x88, WHITE_QUEEN_0x88, CAPTURE_FLAG_0x88),
          ]);
        });
      });
      ...
      describe("when the player is black", () => {
        it("returns the capture with the pormotions", () => {
          const fen = parseFen("8/k7/8/8/8/8/K3p3/4BR2 b - - 0 1");

          expect(getLegalMovesForSquare0x88(fen, E2_0x88)).toMatchMoves([
            encodeMove0x88(E2_0x88, F1_0x88, BLACK_KNIGHT_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E2_0x88, F1_0x88, BLACK_BISHOP_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E2_0x88, F1_0x88, BLACK_ROOK_0x88, CAPTURE_FLAG_0x88),
            encodeMove0x88(E2_0x88, F1_0x88, BLACK_QUEEN_0x88, CAPTURE_FLAG_0x88),
          ]);
        });
      });
    });
  ...
  describe("when the pawn is on the a file and can't capture", () => {
    describe("when the player is white", () => {
      it("returns an empty array", () => {
        ...
        expect(getLegalMovesForSquare0x88(fen, A4_0x88)).toMatchMoves([]);
      });
    });
    ...
    describe("when the player is black", () => {
      it("returns an empty array", () => {
        ...
        expect(getLegalMovesForSquare0x88(fen, A5_0x88)).toMatchMoves([]);
      });
    });
  });
